      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{
              ...
              Your one-stop destination for premium quality products at unbeatable prices. We believe in delivering excellence with every purchase.
            </p>
          </div>
        ...
        <div style={{
          ...
          <p style={{
            ...
            © 2026 Elegant Shop. All rights reserved. Made with ❤️ by You
          </p>
        </div>
      </div>
    </footer>
